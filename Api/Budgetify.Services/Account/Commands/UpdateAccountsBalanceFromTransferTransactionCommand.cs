...
public record UpdateAccountsBalanceFromTransferTransactionCommand(
    int UserId,
    Guid TransactionUid,
...
public class UpdateAccountsBalanceFromTransferTransactionCommandHandler : ICommandHandler<UpdateAccountsBalanceFromTransferTransactionCommand>
{
    ...
    public UpdateAccountsBalanceFromTransferTransactionCommandHandler(
    ...
    public async Task<CommandResult<EmptyValue>> ExecuteAsync(UpdateAccountsBalanceFromTransferTransactionCommand command)
    {
