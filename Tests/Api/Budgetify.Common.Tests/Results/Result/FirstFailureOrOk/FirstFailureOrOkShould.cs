...
[TestFixture(Category = nameof(FirstFailureOrOkShould))]
public class FirstFailureOrOkShould
{
    [Test]
    public void WhenResultsOk_WillReturnOk()
    {
        ...
        // Act
        Result result = Result.FirstFailureOrOk(result1, result2, result3);
    ...
    public void WhenMultipleResultsFail_WillReturnFirstFailedResult()
    {
        ...
        // Act
        Result result = Result.FirstFailureOrOk(result1, result2, result3, result4, result5);
