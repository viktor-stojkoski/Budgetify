...
[TestFixture(Category = nameof(FirstFailureNullOrOkGenericShould))]
public class FirstFailureNullOrOkGenericShould
{
    [Test]
    public void WhenEmptyResults_WillReturnOk()
    {
        ...
        // Act
        Result result = Result.FirstFailureNullOrOk(results);
    ...
    [Test]
    public void WhenResultsHaveOneNullValue_WillReturnOkWithFailureOrNullTrue()
    {
        // Arrange
        Result<string> result1 = Result.Ok("result1");
    ...
    [Test]
    public void WhenResultsHaveMultipleNullValues_WillReturnOkWithFailureOrNullTrue()
    {
        // Arrange
        Result<string> result1 = Result.Ok("result1");
        Result<string> result2 = Result.Ok<string>(null!);
